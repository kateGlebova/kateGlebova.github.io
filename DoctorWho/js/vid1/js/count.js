function CountBox() {
		...
		if (amount < 0) {
			...
			out = "<div class='countbox-hours'><span></span>" + hours + "<div class='countbox-hours-text'>HOURS</div></div>" + "<div class='countbox-mins'><span></span>" + mins + "<div class='countbox-mins-text'>MINUTES</div></div>" + "<div class='countbox-secs'><span></span>" + secs + "<div class='countbox-secs-text'>SECONDS</div></div>";
			var list = document.getElementsByClassName("countbox");
			for (var i = 0; i < list.length; i++) {
				list[i].innerHTML = out;
			}
